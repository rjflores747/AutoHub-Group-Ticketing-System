              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  // include '../connect.php';
                      ...
                      //   if (mysqli_num_rows($resultsqltable)> 0){
                      ...
                      //       echo"<td>"; echo $rowsqltable["ticket_discription"];echo"</td>";
                            ...
                            // echo"<td>"; ?>
                            <!-- <a class="btn btn-warning" href="../admin/ticket_details_container.php?id=<php echo $rowsqltable["id"]; >"><i class='fas fa-eye'></i></a> -->
                            <!-- <a class="btn btn-info" href="../admin/ticket_update_incident_container.php?id=< echo $rowsqltable["id"];?>"> <i class='fas fa-edit'></i></a> -->
