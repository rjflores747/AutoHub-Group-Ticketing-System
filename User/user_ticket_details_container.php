...
<?php include '../navbar/navbar.php';?>
  ...
  <div class="content-wrapper">
       ...
       <br>
       <?php include '../user/user_ticket_details.php';?>
            <!-- Main Content-->
...
var ticket_id = <?=$ticket_id?>;
  ...
  $('#messagebtn').on('click',function(){
    ...
    $.ajax({
        url: "user_function_chat_message_insert.php",
        type: "POST",
        data: {
          ticket_id: ticket_id, 
          message: message,
  ...
  function readmessage(){
    $.ajax({
        url: "user_function_read_chat_message.php",
        type: "POST",
        dataType:"json",
        data: {
          ticket_id: ticket_id, 
...
$('#Updatestatu').on('click',function(){
    ...
    // loadMessage(ajax_response)
    $.ajax({
        url: "user_function_update_status.php",
        type: "POST",
        data: {
          ticket_id: ticket_id, 
          status: status,
