...
-- Schema autohub-ticketing
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `autohub-ticketing` DEFAULT CHARACTER SET utf8mb4 ;
USE `autohub-ticketing` ;

-- -----------------------------------------------------
-- Table `autohub-ticketing`.`employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`employee` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`menu` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`tbl_country`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`tbl_country` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket-category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket-category` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_activity_logs`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_activity_logs` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_assignee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_assignee` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_assignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_assignment` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_chat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_chat` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_deparment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_deparment` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_department_assig`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_department_assig` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_files`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_files` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_incident`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_incident` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `ticket_number` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_0900_ai_ci' NOT NULL,
  `u_id` INT NOT NULL,
  ...
  `ticket_assign_to` VARCHAR(255) CHARACTER SET 'utf8mb4' COLLATE 'utf8mb4_0900_ai_ci' NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_items` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_menu_useraccess`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_menu_useraccess` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_user` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_messegers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_messegers` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `ticket_messegers_ibfk_1`
    ...
    REFERENCES `autohub-ticketing`.`ticket_user` (`id`)
    ON DELETE RESTRICT
    ON UPDATE RESTRICT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_permission`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_permission` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_rating`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_rating` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_role`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_role` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_role_permission`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_role_permission` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_status`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_status` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_status_level`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_status_level` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_sub_menu`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_sub_menu` (
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_suggestions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_suggestions` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `autohub-ticketing`.`ticket_treeview_items`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autohub-ticketing`.`ticket_treeview_items` (
  `id` INT NOT NULL AUTO_INCREMENT,
